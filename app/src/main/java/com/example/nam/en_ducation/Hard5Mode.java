...
public class Hard5Mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hard5_mode);
        ...
        randomSmallJigsawPic.add(R.drawable.long21);
        randomSmallJigsawPic.add(R.drawable.long22);
        randomSmallJigsawPic.add(R.drawable.long23);
        randomSmallJigsawPic.add(R.drawable.long24);
        randomSmallJigsawPic.add(R.drawable.long25);
        randomSmallJigsawPic.add(R.drawable.long26);
        randomSmallJigsawPic.add(R.drawable.long27);
        randomSmallJigsawPic.add(R.drawable.long28);
        randomSmallJigsawPic.add(R.drawable.long29);
    ...
    private void DialogBox(String msg) {
        ...
        builder.setTitle("Jigsaw 1");
        builder.setIcon(R.drawable.logo);
        builder.setMessage(msg)
                .setCancelable(false)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                       // Intent intent1 =new Intent(getApplicationContext(),Hard1Mode.class);
                        finish();
