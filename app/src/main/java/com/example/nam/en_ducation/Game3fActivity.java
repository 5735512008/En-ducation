...
public class Game3fActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game3f);
...
//                    red.setVisibility(View.INVISIBLE);
    ...
    private void delay1() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                drag.setImageResource(R.drawable.dropf15);
                drag3.setImageResource(R.drawable.dropf15a);
                delay();
            }
        }, 1000);
    }
    ...
    private void Change1() {
        ...
        myhandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                drop.setImageResource(R.drawable.dropf15a);
                delay();
            }
        }, 1000);
    ...
    private void Change() {
        ...
        myhandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                drag3.setVisibility(View.INVISIBLE);
                drop1.setVisibility(View.VISIBLE);
                drop.setImageResource(R.drawable.dropf15);
                delay();
            }
        }, 1000);
    }
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), Game3gActivity.class);
