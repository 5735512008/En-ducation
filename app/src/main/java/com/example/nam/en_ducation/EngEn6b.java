...
public class EngEn6b extends AppCompatActivity implements View.OnClickListener{

    ImageView Image;
    int guestionCount = 12;
    ...
    private void setQuestion(int IDchoice) {
        if (IDchoice == 1) {
            Image.setImageResource(R.drawable.m200);
            wordToFind=WORDS[0];
        ...
        if (IDchoice == 2) {
            Image.setImageResource(R.drawable.m205);
            wordToFind=WORDS[1];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
        ...
        if (IDchoice == 3) {
            Image.setImageResource(R.drawable.m204);
            wordToFind=WORDS[2];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
        ...
        if (IDchoice == 4) {
            Image.setImageResource(R.drawable.m203);
            wordToFind=WORDS[3];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
        ...
        if (IDchoice == 5) {
            Image.setImageResource(R.drawable.m202);
            wordToFind=WORDS[4];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");}
        if (IDchoice == 6) {
            Image.setImageResource(R.drawable.m201);
            wordToFind=WORDS[5];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
        ...
        if (IDchoice == 7) {
            Image.setImageResource(R.drawable.m209);
            wordToFind=WORDS[6];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");}
        if (IDchoice == 8) {
            Image.setImageResource(R.drawable.m207);
            wordToFind=WORDS[7];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
        ...
        if (IDchoice == 9) {
            ...
            Image.setImageResource(R.drawable.m206);
            wordToFind=WORDS[8];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");}
        if (IDchoice == 10) {
            Image.setImageResource(R.drawable.m214);
            wordToFind=WORDS[9];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
        ...
        if (IDchoice == 11) {
            Image.setImageResource(R.drawable.m212);
            wordToFind=WORDS[10];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
        ...
        if (IDchoice == 12) {
            Image.setImageResource(R.drawable.m210);
            wordToFind=WORDS[11];
            String wordShuffled=shuffleWord(wordToFind);
            wordTv.setText(wordShuffled);
            wordEnteredit.setText("");
