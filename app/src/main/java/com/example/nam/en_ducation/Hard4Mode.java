...
public class Hard4Mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hard4_mode);
        ...
        randomSmallJigsawPic.add(R.drawable.long41);
        randomSmallJigsawPic.add(R.drawable.long42);
        randomSmallJigsawPic.add(R.drawable.long43);
        randomSmallJigsawPic.add(R.drawable.long44);
        randomSmallJigsawPic.add(R.drawable.long45);
        randomSmallJigsawPic.add(R.drawable.long46);
        randomSmallJigsawPic.add(R.drawable.long47);
        randomSmallJigsawPic.add(R.drawable.long48);
        randomSmallJigsawPic.add(R.drawable.long49);
