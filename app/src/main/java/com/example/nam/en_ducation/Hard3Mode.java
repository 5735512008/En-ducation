...
public class Hard3Mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hard3_mode);
        ...
        randomSmallJigsawPic.add(R.drawable.long31);
        randomSmallJigsawPic.add(R.drawable.long32);
        randomSmallJigsawPic.add(R.drawable.long33);
        randomSmallJigsawPic.add(R.drawable.long34);
        randomSmallJigsawPic.add(R.drawable.long35);
        randomSmallJigsawPic.add(R.drawable.long36);
        randomSmallJigsawPic.add(R.drawable.long37);
        randomSmallJigsawPic.add(R.drawable.long38);
        randomSmallJigsawPic.add(R.drawable.long39);
    ...
    private void DialogBox(String msg) {
        ...
        builder .setTitle("Jigsaw 5");
        builder.setIcon(R.drawable.logo);
        builder .setMessage(msg)
                .setCancelable(false)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                     //   Intent intent1 =new Intent(getApplicationContext(),Hard4Mode.class);
                        finish();
