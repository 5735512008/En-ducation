...
public class EngEn5a extends AppCompatActivity {
    MediaPlayer sound;
    Button choose1, choose2,choose3,choose4;
    TextView score;
    ImageView question;
    private Question5 mQuestion5 = new Question5();
    private String  mAnswer;
    private int mscore =0;
    private int mQuestionsLenght = mQuestion5.mQuestion5.length;
    Random r;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.eng_en5a);
        r = new Random();
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    Toast.makeText(EngEn5a.this,"ถูกต้อง",Toast.LENGTH_LONG).show();
                    mscore++;
                    score.setText("Score:"+mscore);
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==10) {
                        Toast.makeText(EngEn5a.this, "จบเกม", Toast.LENGTH_LONG).show();
                        gameOver();
                    }


                }else{
                    Toast.makeText(EngEn5a.this,"ผิด",Toast.LENGTH_LONG).show();
                    gameOver();
                }
            }
    ...
    private  void  updateQuestion(int num){
        question.setImageResource(mQuestion5.getQuestion5(num));
        choose1.setText(mQuestion5.getChoice1(num));
        choose2.setText(mQuestion5.getChoice2(num));
        choose3.setText(mQuestion5.getChoice3(num));
        choose4.setText(mQuestion5.getChoice4(num));
        mAnswer=mQuestion5.getCorrectAnswer5(num);
    }
                ...
                .setPositiveButton("NEW GAME",
                        new DialogInterface.OnClickListener(){
                            ...
                            public  void onClick(DialogInterface dialogInterface,int i){
                                startActivity(new Intent(getApplicationContext(),EngEn5a.class));
                                finish();
                            }
                        })
