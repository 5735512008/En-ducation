...
public class EngEn3a extends AppCompatActivity {
    MediaPlayer sound;
    ...
    private int mQuestionsLenght = mQuestion3.mQuestion3.length;
    Random r;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.eng_en3a);
        r = new Random();
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    Toast.makeText(EngEn3a.this,"ถูกต้อง",Toast.LENGTH_LONG).show();
                    mscore++;
                    score.setText("Score:"+mscore);
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==15) {
                        Toast.makeText(EngEn3a.this, "จบเกม", Toast.LENGTH_LONG).show();
                        gameOver();
                    }


                }else{
                    Toast.makeText(EngEn3a.this,"ผิด",Toast.LENGTH_LONG).show();
                    gameOver();
                }
            }
    ...
    private  void  updateQuestion(int num){
        question.setImageResource(mQuestion3.getQuestion1(num));
        choose1.setText(mQuestion3.getChoice1(num));
        choose2.setText(mQuestion3.getChoice2(num));
        choose3.setText(mQuestion3.getChoice3(num));
        choose4.setText(mQuestion3.getChoice4(num));
        mAnswer=mQuestion3.getCorrectAnswer2(num);
    }


    private void gameOver(){
      //  AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EngEn3a.this);
      //  alertDialogBuilder
                ...
                .setPositiveButton("NEW GAME",
                        new DialogInterface.OnClickListener(){
                            ...
                            public  void onClick(DialogInterface dialogInterface,int i){
                                startActivity(new Intent(getApplicationContext(),EngEn3a.class));
                                finish();
                            }
                        })
