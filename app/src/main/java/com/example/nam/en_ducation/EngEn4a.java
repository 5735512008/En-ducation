...
public class EngEn4a extends AppCompatActivity {
    MediaPlayer sound;
    Button choose1, choose2,choose3,choose4;
    TextView score;
    ImageView question;
    private Question2 mQuestion2 = new Question2();
    private String  mAnswer;
    private int mscore =0;
    private int mQuestionsLenght = mQuestion2.mQuestion2.length;
    Random r;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.eng_en4a);
        r = new Random();
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    Toast.makeText(EngEn4a.this,"ถูกต้อง",Toast.LENGTH_LONG).show();
                    mscore++;
                    score.setText("Score:"+mscore);
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==15) {
                        Toast.makeText(EngEn4a.this, "จบเกม", Toast.LENGTH_LONG).show();
                        gameOver();
                    }
                }else{
                    Toast.makeText(EngEn4a.this,"ผิด",Toast.LENGTH_LONG).show();
                    gameOver();
                }
            }
    ...
    private  void  updateQuestion(int num){
        question.setImageResource(mQuestion2.getQuestion1(num));
        choose1.setText(mQuestion2.getChoice1(num));
        choose2.setText(mQuestion2.getChoice2(num));
        choose3.setText(mQuestion2.getChoice3(num));
        choose4.setText(mQuestion2.getChoice4(num));
        mAnswer=mQuestion2.getCorrectAnswer2(num);
    }
                ...
                .setPositiveButton("NEW GAME",
                        new DialogInterface.OnClickListener(){
                            ...
                            public  void onClick(DialogInterface dialogInterface,int i){
                                startActivity(new Intent(getApplicationContext(),EngEn4a.class));
                                finish();
                            }
                        })
