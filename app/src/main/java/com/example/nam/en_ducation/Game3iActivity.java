...
public class Game3iActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game3i);
        ...
        drop = (ImageView) findViewById(R.id.imageView7);
...
//                    red.setVisibility(View.INVISIBLE);
    ...
    private void delay1() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                drag2.setImageResource(R.drawable.dropf10);
                drag3.setImageResource(R.drawable.dropf10a);
                delay();
            }
        }, 1000);
    }
    ...
    private void Change1() {
        ...
        myhandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                drop.setImageResource(R.drawable.dropf10a);
                delay();
            }
        }, 1000);
    ...
    private void Change() {
        ...
        myhandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                drag3.setVisibility(View.INVISIBLE);
                drop1.setVisibility(View.VISIBLE);
                drop.setImageResource(R.drawable.dropf10);
                delay();
            }
        }, 1000);
    }
    ...
    private void showscore() {
        ...
        Showscore.setMessage("คุณทำได้       " + strscore + "     คะแนน");

        Showscore.setPositiveButton("ออกจากเกมส์", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent nextquest = new Intent(getApplicationContext(), MainActivity.class);
                startActivity(nextquest);
            }
        });
        Showscore.setNegativeButton("เริ่มใหม่", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent nextquest = new Intent(getApplicationContext(), Game3Activity.class);
                startActivity(nextquest);
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, Game3hActivity.class));
