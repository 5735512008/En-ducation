...
public class Hard2Mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hard2_mode);
        ...
        randomSmallJigsawPic.add(R.drawable.long11);
        randomSmallJigsawPic.add(R.drawable.long12);
        randomSmallJigsawPic.add(R.drawable.long13);
        randomSmallJigsawPic.add(R.drawable.long14);
        randomSmallJigsawPic.add(R.drawable.long15);
        randomSmallJigsawPic.add(R.drawable.long16);
        randomSmallJigsawPic.add(R.drawable.long17);
        randomSmallJigsawPic.add(R.drawable.long18);
        randomSmallJigsawPic.add(R.drawable.long19);
    ...
    private void DialogBox(String msg) {
        ...
        builder .setTitle("Jigsaw 3");
        builder.setIcon(R.drawable.logo);
        builder .setMessage(msg)
                .setCancelable(false)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                       // Intent intent1 =new Intent(getApplicationContext(),Hard3Mode.class);
                        finish();
