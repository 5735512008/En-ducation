...
public class EngEn8a extends AppCompatActivity {
    MediaPlayer sound;
    Button choose1, choose2,choose3,choose4;
    TextView score;
    ImageView question;
    private Question8 mQuestion8 = new Question8();
    private String  mAnswer;
    private int mscore =0;
    private int mQuestionsLenght = mQuestion8.mQuestion8.length;
    Random r;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.eng_en8a);
        r = new Random();
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    Toast.makeText(EngEn8a.this,"ถูกต้อง",Toast.LENGTH_LONG).show();
                    mscore++;
                    score.setText("Score:"+mscore);
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==10) {
                        Toast.makeText(EngEn8a.this, "จบเกม", Toast.LENGTH_LONG).show();
                        gameOver();
                    }


                }else{
                    Toast.makeText(EngEn8a.this,"ผิด",Toast.LENGTH_LONG).show();
                    gameOver();
                }
            }
    ...
    private  void  updateQuestion(int num){
        question.setImageResource(mQuestion8.getQuestion8(num));
        choose1.setText(mQuestion8.getChoice1(num));
        choose2.setText(mQuestion8.getChoice2(num));
        choose3.setText(mQuestion8.getChoice3(num));
        choose4.setText(mQuestion8.getChoice4(num));
        mAnswer=mQuestion8.getCorrectAnswer8(num);
    }
                ...
                .setPositiveButton("NEW GAME",
                        new DialogInterface.OnClickListener(){
                            ...
                            public  void onClick(DialogInterface dialogInterface,int i){
                                startActivity(new Intent(getApplicationContext(),EngEn8a.class));
                                finish();
                            }
                        })
