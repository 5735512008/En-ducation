...
public class Hard1Mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hard1_mode);
        ...
        randomSmallJigsawPic.add(R.drawable.long1);
        randomSmallJigsawPic.add(R.drawable.long2);
        randomSmallJigsawPic.add(R.drawable.long3);
        randomSmallJigsawPic.add(R.drawable.long4);
        randomSmallJigsawPic.add(R.drawable.long5);
        randomSmallJigsawPic.add(R.drawable.long6);
        randomSmallJigsawPic.add(R.drawable.long7);
        randomSmallJigsawPic.add(R.drawable.long8);
        randomSmallJigsawPic.add(R.drawable.long9);
    ...
    private void DialogBox(String msg) {
        ...
        builder .setTitle("Jigsaw 2");
        builder.setIcon(R.drawable.logo);
        builder .setMessage(msg)
                .setCancelable(false)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                      //  Intent intent1 =new Intent(getApplicationContext(),Hard2Mode.class);
                        finish();
